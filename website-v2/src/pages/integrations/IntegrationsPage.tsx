                  ...
                  >
                    ...
                    <div className="space-y-4 flex-1">
                      <div className="space-y-1">
                         <span className="text-[10px] font-black uppercase tracking-widest opacity-40">{int.category}</span>
                    ...
                    <div className="w-full flex items-center justify-between pt-6 border-t border-[var(--border-subtle)] group-hover:border-[var(--brand-primary)]/20 transition-colors">
                       <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[var(--brand-primary)] group-hover:gap-4 transition-all">
                          Setup Guide
        ...
        >
           ...
           <div className="space-y-6 max-w-3xl relative z-10">
              ...
              <h3 className="text-4xl sm:text-7xl font-display font-black tracking-tight leading-[0.95]" style={{ color: 'var(--text-primary)' }}>
                One Mesh. <span className="text-[var(--p-amber-400)]">Global Scale.</span>
              </h3>
